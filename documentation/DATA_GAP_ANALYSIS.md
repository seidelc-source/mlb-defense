...
| 4 | Ground-truth landing-location density (vs. 8 hand-placed Gaussian zones) | unused | Whether coarse zoning materially distorts hit-mass | Use `hc_x/hc_y` directly to build/check a finer empirical density |
...
| 6 | Meaning/label audit of `predicted_hit_pct` semantics for consumers | misaligned | Over-interpretation risk in the UI | RESOLVED (2026-09-02): recalibration validates a per-trajectory isotonic map; relabel once wired |
